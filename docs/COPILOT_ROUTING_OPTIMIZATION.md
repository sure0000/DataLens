...
> 关联文档：[企业语义层与域内自治实践](./企业语义层与域内自治实践.md)、[SEMANTIC_LAYER_OPTIMIZATION_BACKLOG](./SEMANTIC_LAYER_OPTIMIZATION_BACKLOG.md)、[DATALENS_OVERVIEW](./DATALENS_OVERVIEW.md)
...
- 与 [SEMANTIC_LAYER_OPTIMIZATION_BACKLOG](./SEMANTIC_LAYER_OPTIMIZATION_BACKLOG.md) 中指标目录规划对齐。
...
**关联**：企业薄层「跨域关系注册」；见 [企业语义层与域内自治实践](./企业语义层与域内自治实践.md) §4.4。
...
详见 [企业语义层与域内自治实践](./企业语义层与域内自治实践.md) §2.4、§5.4 域团队最小维护清单。

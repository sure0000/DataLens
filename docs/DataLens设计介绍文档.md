...
4. **企业级分层治理** — 企业本体 → 领域本体 → 知识库本体三层架构，跨域共享与域内自治并存
...
Layer 0: Enterprise Ontology (企业本体)
  ...
  → 跨所有业务域共享的顶层概念、属性、公理
  → 文件: backend/ontology/tbox/enterprise.ttl, core.ttl
...
│   ├── tbox/                     # TBox 文件: core.ttl, enterprise.ttl, governance.ttl, provenance.ttl
...
| TBox 本体模型 | ✅ 完成 | 四层架构、30+ 类、30+ 属性、11 SHACL Shape |
